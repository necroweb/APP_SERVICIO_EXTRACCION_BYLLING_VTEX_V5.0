...
▶️ Ejecución del extractor
Ejecutar desde la raíz del proyecto:
Shellpython vtex_invoices_dom_exact.py \  --account tottoco \  --email usuario@correo.com \  --year 2025 \  --month-start 12 \  --month-end 12 \  --headless=false \  --debug=trueMostrar más líneas

Usa --headless=false si debes completar manualmente SSO/MFA.
